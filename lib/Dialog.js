...
var Dialog = function Dialog(originalMessage, timeoutValue, timeoutMessage) {
    ...
    this.receive = function (msg) {
        ...
        if (!matched) {
          if (typeof self.fallbackHandler === 'function') {
            //Call fallback handler if defined
            self.fallbackHandler(msg);
          } else {
    ...
    /**
     * Registers a fallback handler for this dialog
     * @param handler Handler function when there is no match
     */
    this.setFallback = function(handler){
